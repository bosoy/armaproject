...
if (_object isKindOf "Man") then {
  ...
  if (_this select 1 != 1) then {clearWeaponCargo _object; clearMagazineCargo _object;};
    ...
    // primary weapon
      //_object addWeaponCargo ["M4A3_RCO_GL_EP1",1];
      _object addWeaponCargo ["ACE_M4A1_GL",1];
      _object addWeaponCargo ["ACE_HK416_D10_M320",1];
      _object addWeaponCargo ["ACE_HK416_D14_COMPM3_M320",1];
      _object addWeaponCargo ["ACE_M16A2GL_UP",1];
      _object addWeaponCargo ["ACE_M16A4_GL_UP",1];
      _object addWeaponCargo ["SCAR_H_STD_EGLM_Spect",1];
      _object addWeaponCargo ["SCAR_L_CQC_EGLM_Holo",1];
...
//END
if (!isMultiplayer && isServer) then {player globalChat "DEBUG: Gearing Grenadier complete"};
if (true) exitWith{};