...
if (_object isKindOf "Man") then {
  ...
  removeAllWeapons _object; removeAllItems _object;
    ...
    // primary weapon
      _object addWeapon "M4A3_RCO_GL_EP1";
  ...
  if (_this select 1 != 1) then {clearWeaponCargo _object; clearMagazineCargo _object;};
    ...
    // primary weapon
      ...
      _object addWeaponCargo ["ACE_m16a2gl_scope",1];
      //_object addWeaponCargo ["ACE_M16A4_ACG_GL",1];
      _object addWeaponCargo ["SCAR_H_STD_EGLM_Spect",1];
      _object addWeaponCargo ["SCAR_L_STD_EGLM_RCO",1];
