...
//local variables
private ["_object", "_targetInput", "_velocity", "_distance", "_correctAngle", "_setFinalPos", "_target", "_heightStart", "_heightNow", "_objectPos", "_posWtoM", "_xMissing", "_yMissing", "_zMissing", "_distance3D", "_xWalk", "_yWalk", "_zWalk", "_ang"];
