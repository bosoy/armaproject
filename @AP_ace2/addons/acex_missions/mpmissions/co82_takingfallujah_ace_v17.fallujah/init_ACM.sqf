...
_intenzity = 0.22;
if (isMultiplayer) then { _intenzity = (paramsArray select 16) / 100; };
...
[] spawn {
  ...
  ["ground_patrol", 0.8, BIS_ACM1] call BIS_ACM_setTypeChanceFunc; //If you want ground patrols then leave it as a 1, if you don't put a 0. They will use random paths
