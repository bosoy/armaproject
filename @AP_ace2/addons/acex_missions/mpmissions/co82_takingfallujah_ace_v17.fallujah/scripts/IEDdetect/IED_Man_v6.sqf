...
_iedpos = (getpos _man);
_IED = "Land_IED_v1_PMC" createVehicle _iedpos;
nul0 = [_IED,0] execVM "scripts\IEDdetect\IEDdetect_add.sqf";
_man setunitpos "up";
sleep 2;
...
[_man] join GrpNull;
_FS = createVehicle ["TK_soldier_EP1", [000,999,0], [], 0, ""];
_FakeGrp = group _FS;
...
_IEDTarget = createVehicle ["TK_GUE_Bonesetter_EP1", [000,999,0], [], 0, ""];
...
Waituntil {triggeractivated _IEDtriggerOuter};
      ...
      publicVariable "reezo_IEDdetect_canFear";
			nul0 = [_x,_man] execVM "scripts\IEDdetect\IEDdetect_cursorTarget.sqf";

			Sleep (floor (random 5));
			
      while {alive _man && reezo_IEDdetect_cursorTarget > -1 && reezo_IEDdetect_canFear == 1} do { sleep 1 };
        ...
        sleep 1.4;
          ...
          reezo_IEDdetect_Targeters = reezo_IEDdetect_Targeters - [_x];
