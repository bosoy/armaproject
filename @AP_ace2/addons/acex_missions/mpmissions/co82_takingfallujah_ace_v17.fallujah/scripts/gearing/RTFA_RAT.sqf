...
if (_object isKindOf "Man") then {
  ...
  removeAllWeapons _object; removeAllItems _object;
    ...
    // primary weapon
      ...
      _object addWeapon "ACE_M136_CSRS";
  ...
  _object action ["WEAPONONBACK", _object];
    ...
    // primary weapon
      ...
      _object addWeaponCargo ["ACE_M136_CSRS",1];
      _object addWeaponCargo ["ACE_M72",1];
      _object addWeaponCargo ["ACE_M72A2",1];
      ...
      _object addMagazineCargo ["ACE_20Rnd_762x51_B_G3",12];
...
//END
if (!isMultiplayer && isServer) then {player globalChat "DEBUG: Gearing RTFA_RAT complete"};
if (true) exitWith{};