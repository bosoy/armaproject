...
if (_object isKindOf "Man") then {
  ...
  removeAllWeapons _object; removeAllItems _object;
    ...
    // primary weapon
      _object addWeapon "M4A3_CCO_EP1";
    ...
    // backpack
      ...
      _success = [_object, "ACE_Bandage", 16] call ACE_fnc_PackMagazine;_success = [_object, "ACE_LargeBandage", 16] call ACE_fnc_PackMagazine;
  ...
  _object action ["WEAPONONBACK", _object];
    ...
    // primary weapon
      _object addWeaponCargo ["M4A3_CCO_EP1",1];
      _object addWeaponCargo ["ACE_G3A3_RSAS",1];
      _object addWeaponCargo ["ACE_HK416_D10_AIM",1];
      _object addWeaponCargo ["ACE_HK416_D10_COMPM3",1];
      _object addWeaponCargo ["ACE_HK416_D10_Holo",1];
      _object addWeaponCargo ["ACE_HK416_D14_COMPM3",1];
      _object addWeaponCargo ["ACE_HK417_micro",1];
      _object addWeaponCargo ["ACE_HK417_Eotech_4x",1];
      _object addWeaponCargo ["SCAR_H_CQC_CCO",1];
      _object addWeaponCargo ["SCAR_L_CQC_Holo",1];
      _object addWeaponCargo ["SCAR_L_STD_HOLO",1];
      _object addWeaponCargo ["SCAR_L_STD_Mk4CQT",1];
      
      _object addMagazineCargo ["ACE_30Rnd_556x45_SB_Stanag",9];
      _object addMagazineCargo ["ACE_20Rnd_762x51_B_HK417",9];
      _object addMagazineCargo ["ACE_20Rnd_762x51_SB_SCAR",9];
...
_object addMagazineCargo ["ACE_Largebandage",16];
