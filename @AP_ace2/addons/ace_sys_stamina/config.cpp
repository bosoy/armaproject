// config.bin - 18:51:43 05/11/14, generated in 0.06 seconds
...
class CfgMovesBasic {
	...
	class InjuredMovedBase;	// External class reference
};
...
class CfgMovesMaleSdr : CfgMovesBasic {
	class States {
		...
		class AmovPercMstpSlowWrflDnon_AcinPknlMwlkSlowWrflDb_1;	// External class reference
