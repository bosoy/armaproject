#define ACE_STAMINA_LVL_0 0.7 // CIVILIAN //
#define ACE_STAMINA_LVL_1 0.7 // INSURGENT //
#define ACE_STAMINA_LVL_2 0.7 // ARMY // Data is based off regular Army
#define ACE_STAMINA_LVL_3 0.7 // SPECIAL FORCES //
