/* ace_sys_wounds(.pbo) - fnc_stabilize.sqf | (c) 2012, 2013 by rocko */
// #define DEBUG_MODE_FULL
#include "script_component.hpp"

(_this select 0) setVariable ["ace_w_stabilizing_r", true];
_this spawn {
	...
	// TODO: Improve this??
	while {alive _unit && {(_unit getVariable ["ace_w_stabilizing_r", false])} && {(time < _timeOut)}} do {
