...
private ["_index","_droplist","_timelist","_veh","_drop0","_time0","_drop1","_time1","_drop","_flighttime",
"_k","_elev"];

if !(isArray(__magcfg >> "ace_tankfcs_drop")) exitwith {[0,0]};

_droplist = getArray (__magcfg >> "ace_tankfcs_drop");
_timelist = getArray (__magcfg >> "ace_tankfcs_time");
