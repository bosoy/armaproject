// Hud modes setup
   mando_hud_init_code = 
   {
      [0.7,0.8,0.20,false]execVm"mando_missiles\huds\custom\custom_radar.sqf";
   ...
   // Missile parameters for MOAB Bombs (mando_hud_missile = 0);
   mando_hud_misp = [];
   ...
   mando_missileidxbase = mando_missileidxbase + [[-1,"GLT_MOAB_Launcher"]];
