...
KIT_SquadLead = {
	...
	{_unit addMagazine "ACE_33Rnd_9x19_G18"} count [1,2];
	// Weapons
	_unit addWeapon "M16A4_ACG_GL";
	_unit selectWeapon "M16A4_ACG_GL";
	_unit addWeapon "ACE_Glock18";
...
KIT_Medic = {
	...
	[_unit, "ACE_IRStrobe", 1] call ACE_Sys_Ruck_fnc_AddMagToRuck;
	[_unit, "30Rnd_556x45_Stanag", 4] call ACE_Sys_Ruck_fnc_AddMagToRuck;
//	[_unit, "ACE_Bandage", 14] call ACE_Sys_Ruck_fnc_AddMagToRuck;
...
KIT_Armour_HAT = {
	// 12 Slots
	{_unit addMagazine "30Rnd_556x45_Stanag";} count [1,2,3,4,5,6];
	{_unit addWeapon "ACE_Javelin_CLU"} count [1];
	// 8 Minislots
	{_unit addMagazine "ACE_33Rnd_9x19_G18"} count [1,2];
	// Weapons
	_unit addWeapon "M16A4_ACG";
