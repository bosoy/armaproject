/*
  ...
  © DECEMBER 2009 - norrin (norrin@iinet.net.au)
...
_ACE_mod						= 1;				//array no.102 - whether the ACE mod is being used - 0 - no, 1 - yes
// ==================================================================
// LIST OF PLAYABLE UNITS
NORRN_player_units = [
	"FSLA","FMDA","FRA1","FRA2","FRA3","FRA4","FRA5","FRA6","FRA7","FRA8",
	"FSLB","FMDB","FRB1","FRB2","FRB3","FRB4","FRB5","FRB6","FRB7","FRB8",
	"FSLC","FMDC","FRC1","FRC2","FRC3","FRC4","FRC5","FRC6","FRC7","FRC8",
	"FSLD","FMDD","FRD1","FRD2","FRD3","FRD4","FRD5","FRD6","FRD7","FRD8",
	"FCO","FFOCO","FMDCO","FENCO"
];
// ==================================================================
// WELCOME SCREEN
titleText ["Now joining a creoBellum.org mission...\n\nMission concept by Williepete/Delta - Mission design by Wolffy.au", "BLACK FADED", 1]; 	// This next line can be commented out or removed if it interferes with intro movies
// ==================================================================
// REVIVE OPTIONS
...
_caseVAC						= [1, ["HMMWV_Ambulance","MASH"]];	//array no.64 - Allows units to be taken to a hospital etc to be revived
...
_no_team_kills 					= 2;				//array no.99 - Number of teamkills before punishment
// ==================================================================
