class Mando_getmaptgt
{
   idd = 24000;
   movingEnable = true;
   onLoad = "[""onLoad"", _this] call mando_getmaptgt_setup";
   onUnload =  "[""onUnload"", _this] call mando_getmaptgt_setup";

   controlsBackground[] = {MMA_MAPTGTSETUP_BACK_BACKGROUND,MMA_MAPTGTSETUP_BACKGROUND,MMA_MAPTGTSETUP_TEXT};

   class MMA_MAPTGTSETUP_BACK_BACKGROUND
   {
        type = 0;
        style = 128;
        idc = -1;
   ...
   controls[]={MMA_MAPTGTSETUP_MAP,MMA_MAPTGTSETUP_BTN1,MMA_MAPTGTSETUP_BTN2};

   class MMA_MAPTGTSETUP_MAP
   {
      access = 0;
      type = 101;
      style = 48;
      ...
      onMouseZChanged = "";
      onMouseButtonDown = "[""onMapClick"", _this] call mando_getmaptgt";
 ...
 class CustomMark
 {
  ...
  coefMax = 1;
   ...
   class MMA_MAPTGTSETUP_BACKGROUND
   {
        idc = 100;
/*
...
*/
   ...
   class MMA_MAPTGTSETUP_BTN1
   {
  	...
  	action = "[""on_btn1"", _this] call mando_getmaptgt_setup";
	access = ReadAndWrite;
        colorText[] = {1, 1, 1, 1};
        font = "Bitstream";
   ...
   class MMA_MAPTGTSETUP_BTN2
   {
  	...
  	action = "[""on_btn2"", _this] call mando_getmaptgt_setup";
	access = ReadAndWrite;
        colorText[] = {1, 1, 1, 1};
        font = "Bitstream";
	soundEnter[] = {"\ca\ui\data\sound\mouse2",0.09,1};
