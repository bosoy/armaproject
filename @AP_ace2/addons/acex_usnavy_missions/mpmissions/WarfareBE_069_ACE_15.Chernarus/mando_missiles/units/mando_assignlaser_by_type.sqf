/* mando_assignlaser_by_type.sqf.sqf
By Mandoble June 2007

Purpose:
   Waits until a player is in a vehicle which type is in the provided array, and then gives that vehicle a scripted laser designator.
...
private ["_plane", "_alaser", "_inplane", "_planetypes", "_position", "_weapon", "_driver", "_gunner"];
