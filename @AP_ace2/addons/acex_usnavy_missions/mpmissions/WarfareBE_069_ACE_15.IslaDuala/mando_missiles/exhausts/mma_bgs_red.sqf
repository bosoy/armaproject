...
_smoketrail1 setParticleParams ["\ca\data\koulesvetlo","","Billboard",100,1,[0,0,0],[0,0,0],0,_wei,_vol,0.05,[1,2,1.5,0.5],[[1,0,0,0],[1,0,0,0.3],[1,0,0,0.2],[1,0,0,0.1]],[0],0,0,"","",_mis];
