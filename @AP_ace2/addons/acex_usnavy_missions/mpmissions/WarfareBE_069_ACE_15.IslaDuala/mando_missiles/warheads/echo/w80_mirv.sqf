...
for [{_i=0},{_i<3},{_i=_i+1}] do
{
	...
	_log setPos [(_post select 0)+sin(_firingdir)*(1200 + random 300),(_post select 1)+cos(_firingdir)*(1200 + random 300),0];
	...
	_modeinit         = 2;
	_cruisealt        = 100;
	_boomscript       = "mando_missiles\warheads\echo\w80.sqf"; 
