...
if (isNil "d_allmen_E") then {d_allmen_E = ["RU_Soldier_AA","RU_Soldier_HAT","RU_Soldier_AR","RU_Soldier_GL","RU_Soldier_MG","RU_Soldier_Marksman","RU_Soldier_Medic","RU_Soldier","RU_Soldier_LAT","RU_Soldier_AT","RU_Soldier2","RU_Soldier_Sniper","RU_Soldier_Spotter","RU_Soldier_TL"];};
...
X_fnc_spawnVehicle = compile preprocessFileLineNumbers "x_scripts\x_funcs\fn_spawnvehicle.sqf";
X_fnc_spawnCrew = compile preprocessFileLineNumbers "x_scripts\x_funcs\fn_spawncrew.sqf";
BI_fnc_taskPatrol = compile preprocessFileLineNumbers "x_scripts\x_funcs\fn_taskPatrol.sqf";
BI_fnc_taskDefend = compile preprocessFileLineNumbers "x_scripts\x_funcs\fn_taskDefend.sqf";
