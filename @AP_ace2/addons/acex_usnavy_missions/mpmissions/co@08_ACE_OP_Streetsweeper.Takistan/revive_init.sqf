...
_JIP_respawns					= [20,30];			//array no.63 - 0 - off or the number of lives players receive when they join in progress , JIP time after the mission starts 
_revive_timer 					= 1;	 			//array no.7  - Whether you want to limit the amount of timer a player has while unconscious
_revive_time_limit 				= (paramsArray select 3);				//array no.27 - Amount of time a player remains unconscious before respawning or dying
...
_Base_2 						= "Weaponsdepot";	//array no.14
_Base_3 						= "Mortars";		//array no.15
_Base_4 						= "Trucks";			//array no.16 
...
_respawn_button_timer 			= (paramsArray select 4);				//array no.25 - Time until respawn button appears (0 = approx. 12 seconds), NB: Set to a high number like 100000 seconds if you do not want
