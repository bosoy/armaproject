class XD_ViewDistanceDialog
{
	idd = 11098;

	movingEnable = 1;
	onLoad="_test = [] execVM ""x_scripts\x_fillvd.sqf""";
  ...
  class XD_SelectButton
  {
	...
	h = 0.05;
	text = "Select";
	action = "_kk = 0 execVM ""x_scripts\x_setviewdistance.sqf""";
	};
