...
[]spawn
{
   ...
   [["CSLA_Mi24D_4UB32","Mi24_D","Mi24_D_TK_EP1","Mi24_SA_SAR","ACE_Mi24_D_INS"], 0, 0, ["Vehicles"], "MMA Falanga Camera", _mcc_tv_script, _launch_pos, _cam_pos_angles, {(driver _plane == player) && !(isPlayer gunner _plane)}, 0, _weapon_idx, _background_mfd, 1, -3]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";

   [["CSLA_Mi24D_4UB32","Mi24_D","Mi24_D_TK_EP1","Mi24_SA_SAR","ACE_Mi24_D_INS"], 0, 0, ["Vehicles"], "MMA Falanga Camera", _mcc_tv_script, _launch_pos, _cam_pos_angles, 1, 0, _weapon_idx, _background_mfd, 1, -3]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";



// Mi24_P HUD setup for pilot
   [["CSLA_Mi24D_4UB32","Mi24_D","Mi24_D_TK_EP1","Mi24_SA_SAR","ACE_Mi24_D_INS"], 0, "", [], [], 15, 15, 0, [4,3,-2.5], mando_missile_path+"huds\mando_hud_locations.sqf", 0, 0.07, [], 0]execVm"mando_missiles\units\mando_assignvehicle_by_type.sqf";


// Mi24_P HUD setup for gunner
   [["CSLA_Mi24D_4UB32","Mi24_D","Mi24_D_TK_EP1","Mi24_SA_SAR","ACE_Mi24_D_INS"], 1, "", [], [], 15, 15, 0, [4,3,-2.5], "", 0, 0.07, [], 1]execVm"mando_missiles\units\mando_assignvehicle_by_type.sqf";
