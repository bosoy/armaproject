...
call compile format ["if (%1_a) then {waitUntil {!%1_a}};", leader (group _name)];
_pos_leader = getPos (leader (group _name));
...
sleep 2;
_base_1_distance =  _pos_leader distance getMarkerPos _Base_1;
_base_2_distance =  _pos_leader distance getMarkerPos _Base_2;
_base_3_distance =  _pos_leader distance getMarkerPos _Base_3;
_base_4_distance =  _pos_leader distance getMarkerPos _Base_4;
...
sleep 0.01;
[_respawn_base, _name] execVM "revive_sqf\respawn_at_base.sqf";
true;
