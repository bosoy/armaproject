...
[]spawn
{
   ...
   [["Mi24_V","Georgian_Mi24_V","Mi24_V_Iraq","ACE_Mi24_V_FAB250_CDF","CSLA_Mi24V_4UB32","p85_PL_Mi24_V","TPS_PL_Mi24_V","TPS_PL_Mi24_V_olive"], 0, 0, ["Vehicles"], "MMA Shturm Camera", _mcc_tv_script, _launch_pos, _cam_pos_angles, {(driver _plane == player) && !(isPlayer gunner _plane)}, 0, _weapon_idx, _background_mfd, 1, -3]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";

   [["Mi24_V","Georgian_Mi24_V","Mi24_V_Iraq","ACE_Mi24_V_FAB250_CDF","CSLA_Mi24V_4UB32","p85_PL_Mi24_V","TPS_PL_Mi24_V","TPS_PL_Mi24_V_olive"], 0, 0, ["Vehicles"], "MMA Shturm Camera", _mcc_tv_script, _launch_pos, _cam_pos_angles, 1, 0, _weapon_idx, _background_mfd, 1, -3]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";

// Mi24_V HUD setup for pilot
   [["Mi24_V","Georgian_Mi24_V","Mi24_V_Iraq","ACE_Mi24_V_FAB250_CDF","CSLA_Mi24V_4UB32","p85_PL_Mi24_V","TPS_PL_Mi24_V","TPS_PL_Mi24_V_olive"], 0, "", [], [], 15, 15, 0, [4,3,-2.5], mando_missile_path+"huds\mando_hud_locations.sqf", 0, 0.07, [], 0]execVm"mando_missiles\units\mando_assignvehicle_by_type.sqf";


// Mi24_V HUD setup for gunner
   [["Mi24_V","Georgian_Mi24_V","Mi24_V_Iraq","ACE_Mi24_V_FAB250_CDF","CSLA_Mi24V_4UB32","p85_PL_Mi24_V","TPS_PL_Mi24_V","TPS_PL_Mi24_V_olive"], 1, "", [], [], 15, 15, 0, [4,3,-2.5], "", 0, 0.07, [], 1]execVm"mando_missiles\units\mando_assignvehicle_by_type.sqf";
