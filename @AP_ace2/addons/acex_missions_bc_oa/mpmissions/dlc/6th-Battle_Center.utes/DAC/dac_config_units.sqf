...
//--------------------------------------------------------------------------------------------------------------------------------
	...
	{
		_Unit_Pool_S = 	[
							"TK_INS_Soldier_EP1","TK_INS_Soldier_2_EP1","TK_INS_Soldier_3_EP1",
							"TK_INS_Soldier_4_EP1","TK_INS_Soldier_AR_EP1",
							"TK_INS_Bonesetter_EP1","TK_INS_Soldier_AA_EP1",
							"TK_INS_Soldier_AT_EP1","TK_INS_Soldier_AAT_EP1","TK_INS_Soldier_Sniper_EP1",
							"TK_INS_Soldier_MG_EP1","TK_INS_Soldier_TL_EP1","TK_INS_Warlord_EP1"
				];
		_Unit_Pool_V = 	[	"LandRover_MG_TK_INS_EP1","LandRover_SPG9_TK_INS_EP1","BTR40_MG_TK_INS_EP1","BTR40_TK_INS_EP1"
				];
		_Unit_Pool_T = 	[];
		_Unit_Pool_A = 	[];
		_Unit_Pool_U =  [];
