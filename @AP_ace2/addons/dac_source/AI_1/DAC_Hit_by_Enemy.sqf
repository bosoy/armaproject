...
if(!(_fireman in DAC_Fire_Pos)) then {DAC_Fire_Pos = DAC_Fire_Pos + [_fireman]};
if(!(_egroup in DAC_Hit_Groups)) then {DAC_Hit_Groups = DAC_Hit_Groups + [_egroup]};
...
if(!(_egroup in DAC_Radio_Groups)) then {DAC_Radio_Groups = DAC_Radio_Groups + [_egroup]};
