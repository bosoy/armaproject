...
private [
			...
			_countrandom = 0;_max = 0;_HeloArray = [];DAC_Init_Group = DAC_Init_Group + [_DAC_Group_Typ];_run = 9;_GroupPos = [];
			_go = true;_check = 1;_maxrad = 0;_Camp_Pool = [];_groupBehav = [];_DAC_This_Zone = "";_wpConfNr = 0;_DAC_ExtraUnit = [];
			
if(_DAC_Group_Typ == 1) then
{
	{[_x]execVM "\DAC_Source\Scripts\DAC_Create_Groups.sqf"} foreach _ScriptArray;
	_run = 1;
}
else
{
