...
private [
			...
			_countrandom = 0;_max = 0;_HeloArray = [];DAC_Init_Group = DAC_Init_Group + [_DAC_Group_Typ];_run = 9;_GroupPos = [];_action = true;
...
{
	{[_x,_DAC_This_Zone]execVM "\DAC_Source\Scripts\DAC_New_Groups.sqf"} foreach _ScriptArray;
	_run = 1;
}
else
{
	...
	switch (_run) do
	{
							...
							switch (_check) do
							{
											...
											while {_go} do
											{
												...
												else
												{
													...
													else
													{
														...
														{
															_WPTempA = _WPTempA + [_wp];
														}
														else
														{
															_WPTempB = _WPTempB + [_wp];
														};
													};
												};
											};
								...
								case 6:	{
											...
											while {_go} do
											{
												...
												if(_tw == 0) then {_GroupWP = _GroupWP + [_gwp]};
								...
								case 7:	{
											...
											_GroupWP = [];_GroupWP = _GroupWP + [_WPTempA select _zc];
		...
		case 4:		{
						...
						if(_DAC_Group_Typ < 5) then
						{
							...
							while{_h < count DAC_Zones} do {_zData = _zData + [((DAC_Zones select _h) select 0)];_h = _h + 1};
						};
						switch (_DAC_Group_Typ) do
						{
							case 1:	{
										[_countrandom,[_GroupWP,_GroupPos,_zData],1,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]execVM "\DAC_Source\Scripts\DAC_Group_Soldier.sqf";
										[1,[_countrandom,[_GroupWP,_GroupPos,_zData],1,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]]execVM "\DAC_Source\Scripts\DAC_Rebuild_Group.sqf";
									};
							case 2:	{
										[_countrandom,[_GroupWP,_GroupPos,_zData],2,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]execVM "\DAC_Source\Scripts\DAC_Group_Vehicle.sqf";
										[2,[_countrandom,[_GroupWP,_GroupPos,_zData],2,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]]execVM "\DAC_Source\Scripts\DAC_Rebuild_Group.sqf";
									};
							case 3:	{
										[_countrandom,[_GroupWP,_GroupPos,_zData],3,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,_DAC_ExtraUnit,_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]execVM "\DAC_Source\Scripts\DAC_Group_Tank.sqf";
										[3,[_countrandom,[_GroupWP,_GroupPos,_zData],3,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,_DAC_ExtraUnit,_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]]execVM "\DAC_Source\Scripts\DAC_Rebuild_Group.sqf";
									};
							case 4:	{
										[_countrandom,1,[_GroupWP,_GroupPos,_zData],4,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_cwp,_HeloArray,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,_DAC_Zone_Set,_wpConfNr]execVM "\DAC_Source\Scripts\DAC_Group_Air.sqf";
										[4,[_countrandom,1,[_GroupWP,_GroupPos,_zData],4,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_cwp,_HeloArray,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,_DAC_Zone_Set,_wpConfNr]]execVM "\DAC_Source\Scripts\DAC_Rebuild_Group.sqf";
									};
							case 5:	{
										[_countrandom,1,_GroupWP,5,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_cwp,_HeloArray,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,_Camp_Pool,_DAC_Zone_Set,_wpConfNr]execVM "\DAC_Source\Scripts\DAC_Group_Camp.sqf";
										[5,[_countrandom,1,_GroupWP,5,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_cwp,_HeloArray,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,_Camp_Pool,_DAC_Zone_Set,_wpConfNr]]execVM "\DAC_Source\Scripts\DAC_Rebuild_Group.sqf";
									};
							Default {};
						};
						sleep 0.05;
