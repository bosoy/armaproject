...
////////////////////////////////////////////////////////////
// ACE AH-64 Gunner MFD & Targeting System Handler Thread //
// by Headspace                                           //
////////////////////////////////////////////////////////////
...
if (player in [gunner _vehicle, driver _vehicle]) then {
	...
	if (isNil {_vehicle getVariable "AH_MODES_INITIALIZED"}) then {
		...
		AH_CURRENT_WEAPON = currentWeapon _vehicle;
	...
	if (isNil {_vehicle getVariable "AH_SYSTEMS_LOADED"}) then {
		...
		cutRsc ["AH64_MFD_Display", "plain"];	// Internal will care for itself.
	};
};
