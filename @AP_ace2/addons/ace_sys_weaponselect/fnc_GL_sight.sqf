...
private ["_exit","_handlemags","_handlemagsGL","_classes","_sGL","_wh","_mags_unit","_GLmags_unit","_GLmags","_wpnNew","_magGL","_ammoGL","_muzzleGL","_muzzles","_magm", "_mz","_ammo", "_pistol", "_max", "_unit", "_wpn", "_cfg", "_muzzle", "_weapMags", "_dummy", "_dummy2", "_curdummy", "_curmag", "_i", "_s", "_mag"];
// diag_log time;
// diag_log "start";
...
if (_handlemagsGL) then
{
	//removing GL mags
	{
		// diag_log format ["Removing mag %1",_x];
...
[QGVAR(gesture), _unit] call CBA_fnc_localEvent;
sleep 0.7;
